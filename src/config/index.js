...
module.exports = {
  ...
  rateLimit: {
    ...
    // New settings for admin routes
    admin: {
      windowMs: eval(process.env.ADMIN_RATE_LIMIT_WINDOW_MS) || 15 * 60 * 1000, // 15 minutes
      max: process.env.ADMIN_RATE_LIMIT_MAX || 500, // Higher limit for admin routes
    }
  },
};
